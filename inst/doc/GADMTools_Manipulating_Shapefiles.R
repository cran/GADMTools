...
## ----out.width="480px", echo=FALSE, fig.align='center', fig.cap="Loading a single country (level = 0)", fig.pos="h", out.extra=""----
...
## ----out.width="450px", echo=FALSE, fig.cap="loading regions of a country @ level = 2", fig.pos="h", out.extra=""----
...
## ----fig.height=6.5, fig.align='center', fig.cap="Corsica (Region of France) @ level 4", fig.pos="h", out.extra=""----
...
## ----fig.height=6.5, fig.align='center', fig.cap="Corsica - Haute-Corse", fig.pos="ht", out.extra=""----

HCorse <- gadm_subset(Corsica, regions="Haute-Corse", level=2)
gadm_plot(HCorse)

## ----fig.align='center', fig.height=6.7, fig.cap='Corsica with districts only', fig.pos="h", out.extra=""----
...
## ----fig.height=6.5, fig.align='center', fig.cap="Corsica without district of Corte", fig.pos="h", out.extra=""----
